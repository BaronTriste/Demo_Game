...
public class tuto_ennemie : MonoBehaviour
{
    public string[] battleEnnemie = { "", "", "", "", "" };
    void Start()
    {
        battleEnnemie[0] = GameObject.FindGameObjectWithTag("GameController").GetComponent<GameData>().all_text[11];
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        if (other.gameObject.tag == "Player")
        {
            ...
            GameObject.FindGameObjectWithTag("GameController").GetComponent<GameData>().toload = "Battle_didactitiel";
