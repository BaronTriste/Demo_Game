...
public class PNG_script6 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject.Find("Perso1").GetComponent<SpriteRenderer>().sprite = GameObject.Find("PNG6").GetComponent<SpriteRenderer>().sprite;
