...
public class PNG_script4 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject.Find("Perso1").GetComponent<SpriteRenderer>().sprite = GameObject.Find("PNG4").GetComponent<SpriteRenderer>().sprite;
