...
public class PNG_script3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject.Find("Perso1").GetComponent<SpriteRenderer>().sprite = GameObject.Find("PNG3").GetComponent<SpriteRenderer>().sprite;
