...
public class PNG_script2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject.Find("Perso1").GetComponent<SpriteRenderer>().sprite = GameObject.Find("PNG2").GetComponent<SpriteRenderer>().sprite;
