...
public class PNG_script5 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject.Find("Perso1").GetComponent<SpriteRenderer>().sprite = GameObject.Find("PNG5").GetComponent<SpriteRenderer>().sprite;
