...
public class PNG_script8 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject.Find("Perso1").GetComponent<SpriteRenderer>().sprite = GameObject.Find("PNG8").GetComponent<SpriteRenderer>().sprite;
